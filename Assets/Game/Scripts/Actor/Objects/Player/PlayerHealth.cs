...
public class PlayerHealth
{
    ...
    /// </summary>
    [SerializeField]
    private List<PlayerHealthSegment> _healthSegments = new List<PlayerHealthSegment>();
    public PlayerHealthSegment[] HealthSegments => _healthSegments.ToArray();
    /// <summary>
    ...
    public static PlayerHealth CreateNewPlayerData()
    {
    ...
    /// <summary>
    /// Update all health segments.
    /// </summary>
    public void Update(float deltaTime)
    {
        foreach (var segment in HealthSegments)
            segment.UpdateSegment(deltaTime);
    }
    ...
    private void OnHealthSegmentFill(PlayerHealthSegment healthSegment)
    {
