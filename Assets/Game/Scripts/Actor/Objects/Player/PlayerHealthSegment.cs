...
[Serializable]
public class PlayerHealthSegment
{
    public delegate void SegmentDepleted(PlayerHealthSegment healthSegment);
    public event SegmentDepleted Depleted;
    protected virtual void OnDeplete() => Depleted?.Invoke(this);

    public delegate void SegmentFilled(PlayerHealthSegment healthSegment);
    ...
    public bool AllDraining => PlayerHealth.Instance.HealthSegments.All(segment => segment.Draining || segment.Empty);
    /// <summary>
